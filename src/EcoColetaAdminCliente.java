...
public class EcoColetaAdminCliente {
    ...
    private static boolean autenticar(ObjectOutputStream oos, ObjectInputStream ois) throws IOException, ClassNotFoundException {
        ...
        while (opcao != 0) {
            ...
            try {
                ...
                switch (opcao) {
                    ...
                    case 2: cadastrarPonto(); break;
                    case 3: removerPonto(); break;
                    case 0: System.out.println("Saindo do painel."); break;
